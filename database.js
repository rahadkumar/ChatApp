import { _getProvider, getApp as e, _registerComponent as t, registerVersion as n, SDK_VERSION as r } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-app.js";
const i = !1,
    o = "${JSCORE_VERSION}",
    assert = function (e, t) {
    ...
    stringToByteArray$1 = function (e) {
        ...
        for (let r = 0; r < e.length; r++) {
            ...
            i < 128
                ...
                ? ((i = 65536 + ((1023 & i) << 10) + (1023 & e.charCodeAt(++r))), (t[n++] = (i >> 18) | 240), (t[n++] = ((i >> 12) & 63) | 128), (t[n++] = ((i >> 6) & 63) | 128), (t[n++] = (63 & i) | 128))
...
class Provider {
    ...
    getOrInitializeService({ instanceIdentifier: e, options: t = {} }) {
        ...
        if (
            !n &&
            this.component &&
            ((n = this.component.instanceFactory(this.container, { instanceIdentifier: ((r = e), "[DEFAULT]" === r ? void 0 : r), options: t })),
...
const l = { debug: a.DEBUG, verbose: a.VERBOSE, info: a.INFO, warn: a.WARN, error: a.ERROR, silent: a.SILENT },
    h = a.INFO,
    c = { [a.DEBUG]: "log", [a.VERBOSE]: "log", [a.INFO]: "info", [a.WARN]: "warn", [a.ERROR]: "error" },
        ...
        const t = (function (e) {
                ...
                for (let r = 0; r < e.length; r++) {
                    ...
                    i < 128
                        ...
                        : i < 65536
                        ? ((t[n++] = (i >> 12) | 224), (t[n++] = ((i >> 6) & 63) | 128), (t[n++] = (63 & i) | 128))
                        : ((t[n++] = (i >> 18) | 240), (t[n++] = ((i >> 12) & 63) | 128), (t[n++] = ((i >> 6) & 63) | 128), (t[n++] = (63 & i) | 128));
                }
                return t;
            })(e),
            n = new Sha1();
...
const enableLogging$1 = function (e, t) {
        assert(!t || !0 === e || !1 === e, "Can't turn on custom loggers persistently."),
            !0 === e ? ((m.logLevel = a.VERBOSE), (y = m.log.bind(m)), t && _.set("logging_enabled", !0)) : "function" == typeof e ? (y = e) : ((y = null), _.remove("logging_enabled"));
    },
    log = function (...e) {
...
const doubleToIEEE754String = function (e) {
    ...
    0 === e
        ...
        : ((n = e < 0),
          (e = Math.abs(e)) >= Math.pow(2, -1022) ? ((o = Math.min(Math.floor(Math.log(e) / Math.LN2), t)), (r = o + t), (i = Math.round(e * Math.pow(2, 52 - o) - Math.pow(2, 52)))) : ((r = 0), (i = Math.round(e / Math.pow(2, -1074)))));
    const a = [];
...
class FirebaseAuthTokenProvider {
    ...
    getToken(e) {
        return this.auth_
            ? this.auth_.getToken(e).catch((e) => (e && "auth/token-not-initialized" === e.code ? (log("Got auth/token-not-initialized error.  Treating as null token."), null) : Promise.reject(e)))
            : new Promise((t, n) => {
                  setTimeout(() => {
...
class BrowserPollConnection {
    constructor(e, t, n, r, i, o, s) {
        (this.connId = e),
            ...
            (this.urlFn = (e) => (this.appCheckToken && (e.ac = this.appCheckToken), repoInfoConnectionURL(t, "long_polling", e)));
    }
    open(e, t) {
            ...
            (function (e) {
                if ("complete" === document.readyState) e();
                    ...
                    document.addEventListener
                        ? (document.addEventListener("DOMContentLoaded", wrappedFn, !1), window.addEventListener("load", wrappedFn, !1))
    ...
    onConnectionLost_(e) {
        (this.conn_ = null),
            e || 0 !== this.state_
                ...
                : (this.log_("Realtime connection failed."), this.repoInfo_.isCacheableHost() && (p.remove("host:" + this.repoInfo_.host), (this.repoInfo_.internalHost = this.repoInfo_.host))),
            this.close();
    }
...
class EventEmitter {
    ...
    off(e, t, n) {
        ...
        for (let e = 0; e < r.length; e++) if (r[e].callback === t && (!n || n === r[e].context)) return void r.splice(e, 1);
    }
...
function pathChild(e, t) {
    ...
    if (t instanceof Path) for (let e = t.pieceNum_; e < t.pieces_.length; e++) n.push(t.pieces_[e]);
    else {
        const e = t.split("/");
    ...
    onDataPush_(e, t) {
        this.log_("handleServerMessage", e, t),
            "d" === e
                ...
                : error("Unrecognized action received from server: " + stringify(e) + "\nAre you using the latest client?");
    }
    onReady_(e, t) {
...
class LeafNode {
    ...
    updateChild(e, t) {
        ...
        return null === n
            ...
            ? this
            : (assert(".priority" !== n || 1 === pathGetLength(e), ".priority must be the last token in a path"), this.updateImmediateChild(n, LeafNode.__childrenNodeConstructor.EMPTY_NODE.updateChild(pathPopFront(e), t)));
    }
    isEmpty() {
        return !1;
    }
...
class IndexMap {
    ...
    static get Default() {
        return assert(D && x, "ChildrenNode.ts has not been loaded"), (O = O || new IndexMap({ ".priority": D }, { ".priority": x })), O;
    }
    get(e) {
...
Object.defineProperties(NamedNode, { MIN: { value: new NamedNode(v, ChildrenNode.EMPTY_NODE) }, MAX: { value: new NamedNode(C, M) } }),
...
function nodeFromJSON(e, t = null) {
    ...
    }
    {
        ...
        if (r) {
            ...
            return new ChildrenNode(i, nodeFromJSON(t), new IndexMap({ ".priority": e }, { ".priority": x }));
        }
            ...
            : (null != o &&
                  (n.isEmpty()
                      ? e.hasChild(t)
                          ...
                          : assert(e.isLeafNode(), "A child remove without an old child only makes sense on a leaf node")
                      : s.isEmpty()
...
class LimitedFilter {
    ...
    updateChild(e, t, n, r, i, o) {
        return (
            this.rangedFilter_.matches(new NamedNode(t, n)) || (n = ChildrenNode.EMPTY_NODE),
    ...
    fullLimitUpdateChild_(e, t, n, r, i) {
        ...
        return n.isEmpty()
            ? e
            : h && o(l, a) >= 0
            ? (null != i && (i.trackChildChange(changeChildRemoved(l.name, l.node)), i.trackChildChange(changeChildAdded(t, n))), s.updateImmediateChild(t, n).updateImmediateChild(l.name, ChildrenNode.EMPTY_NODE))
            : e;
    }
}
class QueryParams {
...
function queryParamsToRestQueryStringParameters(e) {
    ...
    let n;
    if (
        (e.index_ === x ? (n = "$priority") : e.index_ === W ? (n = "$value") : e.index_ === b ? (n = "$key") : (assert(e.index_ instanceof PathIndex, "Unrecognized index type!"), (n = e.index_.toString())),
...
class AckUserWrite {
    constructor(e, t, n) {
        (this.path = e), (this.affectedTree = t), (this.revert = n), (this.type = q.ACK_USER_WRITE), (this.source = { fromUser: !0, fromServer: !1, queryId: null, tagged: !1 });
    }
    operationForChild(e) {
...
class ImmutableTree {
    ...
    findRootMostMatchingPathAndValue(e, t) {
        if (null != this.value && t(this.value)) return { path: newEmptyPath(), value: this.value };
...
function writeTreeRecordContainsPath_(e, t) {
    ...
    for (const n in e.children) if (e.children.hasOwnProperty(n) && pathContains(pathChild(e.path, n), t)) return !0;
    return !1;
}
...
function writeTreeRefCalcCompleteEventChildren(e, t) {
    return (function writeTreeCalcCompleteEventChildren(e, t, n) {
        ...
        return (
            compoundWriteGetCompleteChildren(compoundWriteChildCompoundWrite(e.visibleWrites, t)).forEach((e) => {
                r = r.updateImmediateChild(e.name, e.node);
            }),
            r
        );
...
function viewProcessorApplyOperation(e, t, n, r, i) {
    ...
    if (n.type === q.OVERWRITE) {
        ...
        l.source.fromUser
            ...
            : (assert(l.source.fromServer, "Unknown source."), (a = l.source.tagged || (t.serverCache.isFiltered() && !pathIsEmpty(l.path))), (s = viewProcessorApplyServerOverwrite(e, t, l.path, l.snap, r, i, a, o)));
        ...
        l.source.fromUser
            ...
            : (assert(l.source.fromServer, "Unknown source."), (a = l.source.tagged || t.serverCache.isFiltered()), (s = viewProcessorApplyServerMerge(e, t, l.path, l.children, r, i, a, o)));
                  ...
                  if (null != writeTreeRefShadowingWrite(r, n)) return t;
                  {
                      ...
                      if (pathIsEmpty(n) || ".priority" === pathGetFront(n)) {
                          ...
                          null == c && t.serverCache.isCompleteForChild(i) && (c = l.getImmediateChild(i)),
                              ...
                              h.isEmpty() && t.serverCache.isFullyInitialized() && ((s = writeTreeRefCalcCompleteEventCache(r, viewCacheGetCompleteServerSnap(t))), s.isLeafNode() && (h = e.filter.updateFullNode(h, s, o)));
                      }
...
function viewApplyOperation(e, t, n, r) {
    t.type === q.MERGE &&
        ...
        (assert(viewCacheGetCompleteServerSnap(e.viewCache_), "We should always have a full cache before handling merges"), assert(viewCacheGetCompleteEventSnap(e.viewCache_), "Missing event cache, even though we have a server cache"));
...
function syncPointRemoveEventRegistration(e, t, n, r) {
    ...
    if ("default" === i) for (const [t, i] of e.views.entries()) (s = s.concat(viewRemoveEventRegistration(i, n, r))), viewIsEmpty(i) && (e.views.delete(t), i.query._queryParams.loadsAllData() || o.push(i.query));
    else {
    ...
    constructor(e) {
        (this.listenProvider_ = e),
            ...
            (this.pendingWriteTree_ = (function newWriteTree() {
                return { visibleWrites: CompoundWrite.empty(), allWrites: [], lastWriteId: -1 };
            })()),
...
function syncTreeApplyUserOverwrite(e, t, n, r, i) {
    return (
        ...
        i ? syncTreeApplyOperationToSyncPoints_(e, new Overwrite({ fromUser: !0, fromServer: !1, queryId: null, tagged: !1 }, t, n)) : []
    );
}
function syncTreeApplyUserMerge(e, t, n, r) {
    !(function writeTreeAddMerge(e, t, n, r) {
        assert(r > e.lastWriteId, "Stacking an older merge on top of newer ones"), e.allWrites.push({ path: t, children: n, writeId: r, visible: !0 }), (e.visibleWrites = compoundWriteAddWrites(e.visibleWrites, t, n)), (e.lastWriteId = r);
    })(e.pendingWriteTree_, t, n, r);
    const i = ImmutableTree.fromObject(n);
    return syncTreeApplyOperationToSyncPoints_(e, new Merge({ fromUser: !0, fromServer: !1, queryId: null, tagged: !1 }, t, i));
}
...
function syncTreeApplyServerOverwrite(e, t, n) {
    return syncTreeApplyOperationToSyncPoints_(e, new Overwrite({ fromUser: !1, fromServer: !0, queryId: null, tagged: !1 }, t, n));
}
                ...
                if (i) assert(!syncPointHasCompleteView(a.value), "If we're adding a query, it shouldn't be shadowed");
                    ...
                    const t = a.fold((e, t, n) => {
                        if (!pathIsEmpty(e) && t && syncPointHasCompleteView(t)) return [syncPointGetCompleteView(t).query];
                        {
                            let e = [];
                            return (
                                t && (e = e.concat(syncPointGetQueryViews(t).map((e) => e.query))),
                                each(n, (t, n) => {
                                    e = e.concat(n);
                                }),
                                e
            ...
            if ("ok" === t)
                return r
                    ...
                    : (function syncTreeApplyListenComplete(e, t) {
                          return syncTreeApplyOperationToSyncPoints_(e, new ListenComplete({ fromUser: !1, fromServer: !0, queryId: null, tagged: !1 }, t));
                      })(e, n._path);
            {
...
function syncTreeParseQueryKey_(e) {
    const t = e.indexOf("$");
    return assert(-1 !== t && t < e.length - 1, "Bad queryKey."), { queryId: e.substr(t + 1), path: new Path(e.substr(0, t)) };
}
...
const resolveDeferredLeafValue = function (e, t, n) {
        return e && "object" == typeof e
            ? (assert(".sv" in e, "Unexpected leaf node or priority contents"),
              "string" == typeof e[".sv"] ? resolveScalarDeferredValue(e[".sv"], t, n) : "object" == typeof e[".sv"] ? resolveComplexDeferredValue(e[".sv"], t) : void assert(!1, "Unexpected server value: " + JSON.stringify(e, null, 2)))
            : e;
    },
...
const H = /[\[\].#$\/\u0000-\u001F\u007F]/,
    ...
    validateFirebaseData = function (e, t, n) {
        ...
        if (t && "object" == typeof t) {
            ...
            if (
                (each(t, (t, o) => {
                    if (".value" === t) n = !0;
                    else if (".priority" !== t && ".sv" !== t && ((i = !0), !isValidKey(t)))
    ...
    validateFirebaseMergeDataArg = function (e, t, n, r) {
        ...
        each(t, (e, t) => {
            const r = new Path(e);
            if ((validateFirebaseData(i, t, pathChild(n, r)), ".priority" === pathGetBack(r) && !isValidPriority(t)))
    ...
    validateUrl = function (e, t) {
        ...
        if (
            ...
            (!isValidKey(t.repoInfo.namespace) && "localhost" !== t.repoInfo.host.split(":")[0]) ||
            (0 !== n.length &&
                !(function (e) {
...
function eventQueueQueueEvents(e, t) {
    ...
    for (let r = 0; r < t.length; r++) {
        const i = t[r],
            o = i.getPath();
        null === n || pathEquals(o, n.path) || (e.eventLists_.push(n), (n = null)), null === n && (n = { events: [], path: o }), n.events.push(i);
    }
...
function repoGenerateServerValues(e) {
    return ((t = (t = { timestamp: repoServerTime(e) }) || {}).timestamp = t.timestamp || new Date().getTime()), t;
    var t;
}
function repoOnDataUpdate(e, t, n, r, i) {
    ...
    if (i)
        ...
        s = (function syncTreeApplyServerMerge(e, t, n) {
            ...
            return syncTreeApplyOperationToSyncPoints_(e, new Merge({ fromUser: !1, fromServer: !0, queryId: null, tagged: !1 }, t, r));
        ...
        n.every((e) => 0 === e.status) &&
            (function repoSendTransactionQueue(e, t, n) {
                ...
                e.server_.put(
                    ...
                    a,
                    (r) => {
                        repoLog(e, "transaction put response", { path: l.toString(), status: r });
                        let i = [];
                        if ("ok" === r) {
                            const r = [];
                            for (let t = 0; t < n.length; t++)
                            ...
                            if ("datastale" === r) for (let e = 0; e < n.length; e++) 3 === n[e].status ? (n[e].status = 4) : (n[e].status = 0);
                            else {
...
function repoAbortTransactionsOnNode(e, t) {
    ...
    if (n) {
        ...
        for (let t = 0; t < n.length; t++)
            3 === n[t].status ||
                (1 === n[t].status
                    ? (assert(o === t - 1, "All SENT items should be at beginning of queue."), (o = t), (n[t].status = 3), (n[t].abortReason = "set"))
                    : (assert(0 === n[t].status, "Unexpected transaction status in abort"),
                      n[t].unwatcher(),
        ...
        -1 === o ? treeSetValue(t, void 0) : (n.length = o + 1), eventQueueRaiseEventsForChangedPath(e.eventQueue_, treeGetPath(t), i);
        for (let e = 0; e < r.length; e++) exceptionGuard(r[e]);
    }
}
const parseRepoInfo = function (e, t) {
        ...
        return { repoInfo: new RepoInfo(n.host, n.secure, r, i, t, "", r !== n.subdomain), path: new Path(n.pathString) };
    },
    parseDatabaseURL = function (e) {
        ...
        return { host: t, port: l, domain: n, subdomain: r, secure: s, scheme: a, pathString: i, namespace: o };
    },
...
function validateQueryEndpoints(e) {
    ...
    } else if ((assert(e.getIndex() instanceof PathIndex || e.getIndex() === W, "unknown index type."), (null != t && "object" == typeof t) || (null != n && "object" == typeof n)))
...
function refFromURL(e, t) {
    ...
    const r = n.repoInfo;
    return (
        e._repo.repoInfo_.isCustomHost() || r.host === e._repo.repoInfo_.host || fatal("refFromURL: Host name does not match the current database: (found " + r.host + " but expected " + e._repo.repoInfo_.host + ")"),
...
function child(e, t) {
    var n, r, i, o;
    return (
        null === pathGetFront((e = getModularInstance(e))._path) ? ((n = "child"), (r = "path"), (o = !1), (i = t) && (i = i.replace(/^\/*\.info(\/|$)/, "/")), validatePathString(n, r, i, o)) : validatePathString("child", "path", t, !1),
...
function setWithPriority(e, t, n) {
    if ((validateWritablePath("setWithPriority", e._path), validateFirebaseDataArg("setWithPriority", t, e._path, !1), validatePriority("setWithPriority", n, !1), ".length" === e.key || ".keys" === e.key))
    ...
    return (
        (function repoUpdate(e, t, n, r) {
            ...
            if (
                ...
                log("update() called with empty data.  Don't do anything."), repoCallOnCompleteCallback(0, r, "ok", void 0);
            else {
...
function repoManagerDatabaseFromApp(e, t, n, r, i) {
    ...
    void 0 === o &&
        (e.options.projectId || fatal("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),
            ...
            if (void 0 === l) s.unwatcher(), (s.currentOutputSnapshotRaw = null), (s.currentOutputSnapshotResolved = null), s.onComplete && s.onComplete(null, !1, s.currentInputSnapshot);
                ...
                r.push(s),
                    ...
                    "object" == typeof l && null !== l && contains(l, ".priority")
                        ? ((i = safeGet(l, ".priority")), assert(isValidPriority(i), "Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null."))
                        : (i = (syncTreeCalcCompleteEventCache(e.serverSyncTree_, t) || ChildrenNode.EMPTY_NODE).getPriority().val());
                const o = repoGenerateServerValues(e),
                    h = nodeFromJSON(l, i),
...
function _initStandalone({ app: e, url: t, version: n, customAuthImpl: r, customAppCheckImpl: i, nodeAdmin: o = !1 }) {
    ...
    let l;
    return (
        i && ((l = new Provider("app-check-internal", s)), l.setComponent(new Component("app-check-internal", () => i, "PRIVATE"))),
...
!(function registerDatabase(e) {
    setSDKVersion(r),
        t(
            new Component("database", (e, { instanceIdentifier: t }) => repoManagerDatabaseFromApp(e.getProvider("app").getImmediate(), e.getProvider("auth-internal"), e.getProvider("app-check-internal"), t), "PUBLIC").setMultipleInstances(
                !0
            )
        ),
        n(d, "1.0.2", e),
